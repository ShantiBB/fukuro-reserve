...
const file_booking_v1_booking_proto_rawDesc = "" +
	...
	"\abooking\x18\x01 \x01(\v2\x13.booking.v1.BookingR\abooking\"\xbb\x04\n" +
	"\aBooking\x12\x0e\n" +
...
var file_booking_v1_booking_proto_depIdxs = []int32{
	5,  // 0: booking.v1.CreateBookingRequest.check_in:type_name -> google.protobuf.Timestamp
	5,  // 1: booking.v1.CreateBookingRequest.check_out:type_name -> google.protobuf.Timestamp
	...
	5,  // 4: booking.v1.Booking.check_in:type_name -> google.protobuf.Timestamp
	5,  // 5: booking.v1.Booking.check_out:type_name -> google.protobuf.Timestamp
	0,  // 6: booking.v1.Booking.status:type_name -> booking.v1.BookingStatus
	5,  // 7: booking.v1.Booking.created_at:type_name -> google.protobuf.Timestamp
	5,  // 8: booking.v1.Booking.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 9: booking.v1.BookingService.CreateBooking:input_type -> booking.v1.CreateBookingRequest
	3,  // 10: booking.v1.BookingService.CreateBooking:output_type -> booking.v1.CreateBookingResponse
...
func file_booking_v1_booking_proto_init() {
	...
	file_booking_v1_booking_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
