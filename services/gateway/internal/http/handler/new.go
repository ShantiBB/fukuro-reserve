...
type hotelService interface {
	...
	GetHotelByID(ctx context.Context, countryCode, citySlug, hotelID string) (*dto.HotelResponse, error)
	UpdateHotelByID(ctx context.Context, countryCode, citySlug, hotelID string, req dto.UpdateHotelRequest) (*dto.HotelResponse, error)
	UpdateHotelTitleByID(ctx context.Context, countryCode, citySlug, hotelID string, req dto.UpdateHotelTitleRequest) (*dto.HotelResponse, error)
	DeleteHotelByID(ctx context.Context, countryCode, citySlug, hotelID string) error
	CreateRoomByHotelID(ctx context.Context, countryCode, citySlug, hotelID string, req dto.CreateRoomRequest) (*dto.RoomResponse, error)
	GetRooms(ctx context.Context, countryCode, citySlug, hotelSlug string, page, limit uint64) (*dto.RoomsResponse, error)
	GetRoomsByHotelID(ctx context.Context, countryCode, citySlug, hotelID string, page, limit uint64) (*dto.RoomsResponse, error)
	GetRoom(ctx context.Context, countryCode, citySlug, roomID string) (*dto.RoomResponse, error)
	UpdateRoom(ctx context.Context, countryCode, citySlug, roomID string, req dto.UpdateRoomRequest) (*dto.RoomResponse, error)
	UpdateRoomStatus(ctx context.Context, countryCode, citySlug, roomID string, req dto.UpdateRoomStatusRequest) (*dto.StatusResponse, error)
	DeleteRoom(ctx context.Context, countryCode, citySlug, roomID string) error
}
...
type bookingService interface {
	...
	QuoteBooking(ctx context.Context, countryCode, citySlug, hotelID string, req dto.QuoteBookingRequest) (*dto.QuoteBookingResponse, error)
