...
func (s *Auth) CreateUser(ctx context.Context, req dto.CreateUserRequest) (*dto.UserResponse, error) {
	...
	resp, err := s.clients.User.CreateUser(
...
func (s *Auth) UpdateUser(ctx context.Context, id int64, req dto.UpdateUserRequest) (*dto.UserResponse, error) {
	resp, err := s.clients.User.UpdateUser(
...
func (s *Auth) UpdateUserActivity(
	ctx context.Context, id int64, req dto.UpdateUserActivityRequest,
) (*dto.UpdateUserActivityResponse, error) {
	resp, err := s.clients.User.UpdateUserActivity(
...
func (s *Auth) UpdateUserRole(
	ctx context.Context, id int64, req dto.UpdateUserRoleRequest,
) (*dto.UpdateUserRoleResponse, error) {
	resp, err := s.clients.User.UpdateUserRole(
