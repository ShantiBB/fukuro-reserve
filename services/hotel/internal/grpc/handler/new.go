...
type HotelService interface {
	...
	UpdateHotelTitleByID(ctx context.Context, id uuid.UUID, h models.UpdateHotelTitle) (models.UpdateHotelTitle, error)
...
type RoomService interface {
	...
	CreateRoomByHotelID(ctx context.Context, hotelID uuid.UUID, room *models.CreateRoom) (*models.Room, error)
	GetRooms(ctx context.Context, hotelRef models.HotelRef, page, limit uint64) (*models.RoomList, error)
	GetRoomsByHotelID(ctx context.Context, hotelID uuid.UUID, page, limit uint64) (*models.RoomList, error)
